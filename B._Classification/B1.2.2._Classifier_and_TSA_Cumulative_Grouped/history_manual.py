...
data_tsa = pd.read_csv('../../Cern_Time_Series/df_predict_g_labeled_1year_6month_cumulative_10_14.csv')
...
#Load original data
data_origin = pd.read_excel('../../popularity-728days_my.xls')
data_tsa2 = pd.read_csv('../../Cern_Time_Series/df_predict_g_labeled_6month_cumulative_10_08.csv')
