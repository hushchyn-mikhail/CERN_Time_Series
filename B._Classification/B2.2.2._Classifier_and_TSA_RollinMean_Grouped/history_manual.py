...
data_tsa = pd.read_csv('../../Cern_Time_Series/df_predict_g_labeled_1year_6month_rolling_mean_10_14.csv')
data = pd.concat([data_origin, data_tsa.drop(['Name', 'Configuration', 'ProcessingPass', 'FileType'], axis = 1)], axis = 1)
data.columns
...
#Load original data
data_origin = pd.read_excel('../../popularity-728days_my.xls')
data_tsa2 = pd.read_csv('../../Cern_Time_Series/df_predict_g_labeled_6month_rolling_mean_10_08.csv')
data2 = pd.concat([data_origin, data_tsa2.drop(['Name', 'Configuration', 'ProcessingPass', 'FileType'], axis = 1)], axis = 1)
data.columns
