...
data_res = pd.read_csv('../../Cern_Time_Series/df_predict_labeled_1year_6month_rolling_mean_10_14.csv')
data_res.columns
...
data_sig.to_csv('/home/mikhail91/Documents/LBox/Cern_Time_Series/Classification/data_sig_res_1year_6month_cumulative_10_15.csv')
data_bck.to_csv('/home/mikhail91/Documents/LBox/Cern_Time_Series/Classification/data_bck_res_1year_6month_cumulative_10_15.csv')
...
#Selection
sel = ((data['Now'] - data['Creation-week']) > 52)&((data['Now'] - data['FirstUsage']) > 52)&((data[52] - data[1]) == 0)
...
session.commit("variables were added")